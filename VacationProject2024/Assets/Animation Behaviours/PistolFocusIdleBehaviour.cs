...
using UnityEngine;
public class PistolFocusIdleBehaviour : PlayerAnimationBehaviour
{
    ...
    {
        if (player.pistolCounter >= player.pistolFocusFireRate && Input.GetMouseButtonDown(0) && player.pistolMag > 0)
        {
