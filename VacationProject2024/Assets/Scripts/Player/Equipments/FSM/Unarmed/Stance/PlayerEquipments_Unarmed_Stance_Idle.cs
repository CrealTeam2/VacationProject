...
public class PlayerEquipments_Unarmed_Stance_Idle : State<Player>
{
    public PlayerEquipments_Unarmed_Stance_Idle(Player origin, Layer<Player> parent) : base(origin, parent)
    {
